...
public  class AC_DicomDictionary {
	...
	public static HashMap<Integer, String> m_Discription = new  HashMap<Integer, String>();
	...
	public static void setupList()
	{
		...
		try {
			for(int i=0; i<nTagID;i++)
			{
				...
				m_Discription.put(iTagID, sTagIDName);
			}
	...
	public  static String getDiscription(int TagID)
	{
		if(m_Discription.containsKey(TagID))
			return m_Discription.get(TagID);
		return "";
	}
